      ...
      `}>
        <div className="p-6 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl gradient-primary flex items-center justify-center text-lg shadow-elegant">
              🏡
            </div>
            <div>
              <div className="text-base font-bold tracking-tight gradient-text font-display">RentIntel</div>
              <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground mt-0.5">Smart Analyzer</p>
            </div>
          </div>
        </div>
